...
<div class="sales-view">
  ...
  <div class="col-lg-8">
    ...
    <?= Html::a(Yii::t('app', 'Print Invoice'), ['surat-jalan', 'id' => $model->id], ['class' => 'btn btn-primary mr-2']) ?>
    <?= Html::a(Yii::t('app', 'Update Stok Barang'), ['surat-jalan', 'id' => $model->id], ['class' => 'btn btn-primary mr-2']) ?>
  </div>
</div>