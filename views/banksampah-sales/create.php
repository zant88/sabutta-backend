...
if (Yii::$app->user->can('admin')) {
  ?>
  <h3>Hanya user bank sampah yang bisa akses halaman ini!</h3>
  <?php
}else {
  ?>
      ...
      <div class="row">
        <div class="col-lg-8">
                ...
                <div class="col-lg-6">
                  <div class="form-group field-sales-vendor_id required has-error">
                    <div class="form-group">
                      ...
                      <input type="text" value="Sabutta"  class="form-control" disabled id="vendor" />
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="btn-container mt-3 text-right">
            <a class="btn btn-success" v-on:click="save()">Simpan</a>
          </div>
        </div>
      </div>
    </div>
  ...
  $this->registerJsFile(
    '@web/js/views/banksampah-sales.js',
    ['depends' => [\yii\web\JqueryAsset::class]]
  );
